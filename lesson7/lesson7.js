...
function init() {
    ...
    sumTotal.classList.add("sum");
    sumTotal.innerText = "Количество очков = " + score;
    document.getElementsByClassName("wrap")[0].append(sumTotal);
...
function move() {
    ...
    if (direction == 'x-') {
        new_unit = document.getElementsByClassName('cell-' + (coord_y) + '-' + (coord_x == 0 ? FIELD_SIZE_X - 1 : coord_x - 1))[0];
    }
    else if (direction == 'x+') {
        new_unit = document.getElementsByClassName('cell-' + (coord_y) + '-' + (coord_x == FIELD_SIZE_X - 1 ? 0 : coord_x + 1))[0];
    }
    else if (direction == 'y+') {
        new_unit = document.getElementsByClassName('cell-' + (coord_y == 0 ? FIELD_SIZE_Y - 1 : coord_y - 1) + '-' + (coord_x))[0];
    }
    else if (direction == 'y-') {
        new_unit = document.getElementsByClassName('cell-' + (coord_y == FIELD_SIZE_Y - 1 ? 0 : coord_y + 1) + '-' + (coord_x))[0];
    }
